/** 이벤트 고유번호, 어권 별 문자 등, 각 이벤트 고유 값 세팅. */

var eventId = "ca1fd0dd-cd84-1388-7bab-502e01bf1ad0";// 이벤트 고유 아이디, 어권마다 다름.
var lang = "cht";
var componentIds = [
    "700613d0-5775-bfcf-a02c-64847523a7a6"
    , "8803b538-a523-a67f-1504-29bd4561a823"
    , "e4bbd16f-0bd7-b1b4-7250-446acac67971"
    , "b27927c8-69c2-1ffd-6c85-2d1dc73755f1"
    , "c858109f-548b-65f8-0b48-1c7798c3548e"
]
...
var alreadyClickMessage = "您已選擇本景點";
var linkCopiedMessage = "已複製URL";

// var GTM_ID = "GTM-K8TQHNG";
// var gtmId = getCookie("CookiePop") ? GTM_ID : "";


$(function() {
    $('.placeList').each(function(idx, el) {
        el.id = componentIds[idx];
        $('#' + el.id + ' .img_wrap em').text('0');
        $('#' + el.id + ' .img_wrap button').prop('class', '');
    });
